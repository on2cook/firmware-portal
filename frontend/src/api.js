...
export const api = {
  ...
  downloadFile: async (releaseId, fileType, suggestedName) => {
    ...
    // Prefer the caller-supplied name (from the release data), then the server's
    ...
    // Guarantee the correct extension for the requested file type, so an app
    // file ALWAYS downloads as .apk regardless of the stored/header name.
